...
<br>
	...
	<a href="Edit_job_mnsp.php?Num_ID=<?php echo $result["Num_ID"]; ?>" ><img src="image/BEdit.png" width="40" height="30"></a>
...
<!--------------------------- Button --------------------------->
			<td><center><?php
			if($result["Monitor"] == "NO"){
			echo '<font color="red"><b>NO</b></font>';
			}else{
			echo '<a href="'.$result["Monitor"].'" target="_blank"><img src="image/BDownload.png" width="40" height="30"></a>';
			}
			?>
			</center></td>
        </tr>
