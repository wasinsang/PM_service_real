                        ...
                        <div id="report" class="form-group" >
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="Due_Date" name="Due_Date" placeholder="กำหนดส่ง" value="<?php echo $result["Due_Date"];?>" required>
                                    <div class="valid-feedback">
                                      Looks good!
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="Detail" name = "Detail" placeholder="Detail" value="<?php echo $result["Detail"];?>" required>
                                    <div class="invalid-feedback">
