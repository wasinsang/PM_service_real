...
//  }
 ...
 if($error == '')
 {
  ...
  $query = "
  INSERT INTO mnsp 
  (Customer_Name, SO_Ter, Customer_id, Customer_info, PM_Name, Sale_Name, Pre_Sale, Service, SO_Num, SO_file, Start_Date, End_Date) 
  VALUES (:Customer_Name, :SO_Ter, :Num_ID, :Customer_info, :PM_Name, :Sale_Name, :Pre_sale, :Service, :SO_Num, :SO_File, :Start_Date, :END_Date)
  ";
  // $query = "
  // INSERT INTO pm_mnsp 
