...
if(isset($_POST["Customer_Name"]))
{
 ...
 {
  $error .= '<p>Due_Date is Required</p>';
 }
 else
 {
 ...
 if($error == '')
 {
  ...
  $query = "
  INSERT INTO Report 
  (Customer_Name, SO_Ter, Customer_id, Customer_info, PM_Name, Sale_Name, Pre_Sale, Service, SO_Num, SO_File, Start_Date, End_Date ,Due_Date, Detail) 
  VALUES (:Customer_Name, :SO_Ter, :Num_ID, :Customer_info, :PM_Name, :Sale_Name, :Pre_sale, :Service, :SO_Num, :SO_File, :Start_Date, :END_Date, :Due_Date, :Detail)
  ";
