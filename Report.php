                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..." id="myInput" onkeyup="myFunction()" aria-label="Search" aria-describedby="basic-addon2">
                        </div>
                    </form>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="w3-table-all" id="customer_data" width="100%" cellspacing="0">
                                    <thead>
                                        <tr class="w3-orange w3-hover-red">
                                            <th>Customer Name</th>
                                            <th>Customer ID</th>
                                            <th>Customer info</th>
                                            <th>SO No.</th>
